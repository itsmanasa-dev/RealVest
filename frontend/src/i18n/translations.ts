...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    verified_ml_models: 'Valuation Engine Active',
    ...
    ml_fair_value: 'Estimated Fair Value',
  ...
  hi: {
    ...
    verified_ml_models: 'वैल्यूएशन इंजन सक्रिय',
    ...
    ml_fair_value: 'अनुमानित उचित मूल्य',
  ...
  kn: {
    ...
    verified_ml_models: 'ಮೌಲ್ಯಮಾಪನ ಸಕ್ರಿಯವಾಗಿದೆ',
    ...
    ml_fair_value: 'ಅಂದಾಜು ನ್ಯಾಯಯುತ ಮೌಲ್ಯ',
